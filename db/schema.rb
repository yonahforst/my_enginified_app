...
ActiveRecord::Schema.define(version: 20140721181843) do
  ...
  add_index "core_users", ["authentication_token"], name: "index_core_users_on_authentication_token", unique: true, using: :btree
